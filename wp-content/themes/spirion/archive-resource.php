                ...
                <div class="row">
					...
					$term_list = $terms = get_terms(array(
						...
						'order' => 'ASC',
							...
							//print_r($term_list); 
					?>
                                <li class="active"><a href="<?php echo get_post_type_archive_link('resource'); ?>" class="active">All (<?php echo $count_posts; ?>)</a></li>
                                <?php foreach ($term_list as $term) : ?>
									<li><a href="<?php echo get_term_link($term->term_id); ?>"><?php echo $term->name; ?> (<?php echo $term->count; ?>)</a></li>
								<?php endforeach; ?>	
